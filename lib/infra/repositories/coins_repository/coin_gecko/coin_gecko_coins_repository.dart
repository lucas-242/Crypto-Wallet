...
//   }) async {
//     try {
//       final String formattedCoins = _formatToUrl(coins);
//       final String formattedCurrencies = _formatToUrl(currencies);
//       final uri =
...
//   }) async {
//     try {
//       formattedCoins ??= _formatToUrl(coins);
...
//       final result = List<MarketcapApiResponse>.from(
...
//     final List<MarketcapApiResponse> response = [];
//     final formattedCoins = _formatToUrl(Cryptos.list);

//     final pages = (Cryptos.list.length / Config.apiResultLimit).ceil();
